...
SKILL_DESCRIPT = {
	...
	[SKID.MG_THUNDERSTORM] = {
		...
		"Thunder Storm's range. Each strikes inflicts an",
		"amount of damage equal to 80% of the caster's",
		"Matk strength.^000000",
		"[Lv 1]:^77777729 SP, 1 Bolt^000000",
		"[Lv 2]:^77777734 SP, 2 Bolts^000000",
		"[Lv 3]:^77777739 SP, 3 Bolts^000000",
		"[Lv 4]:^77777744 SP, 4 Bolts^000000",
		"[Lv 5]:^77777749 SP, 5 Bolts^000000",
		"[Lv 6]:^77777754 SP, 6 Bolts^000000",
		"[Lv 7]:^77777759 SP, 7 Bolts^000000",
		"[Lv 8]:^77777764 SP, 8 Bolts^000000",
		"[Lv 9]:^77777769 SP, 9 Bolts^000000",
		"[Lv 10]:^77777774 SP, 10 Bolts^000000"
	},
	[SKID.AL_DP] = {
		"[Divine Protection]",
		"Max Level: 10",
	...
	[SKID.SN_SHARPSHOOTING] = {
		...
		"Max Level: 5",
		"^777777Skill Requirement: Double Strafe 5,",
	...
	[SKID.RK_SONICWAVE] = {
		...
		"Skill Form: ^777777Offensive^000000",
		"Description: ^777777Smashes your weapon to the ground creating a sonic wave that damages a target in the distance.",
		"Skill level affects its accuracy. Damage increases with the caster's Base Level.^000000",
		"[Lv 1] ^777777ATK 800%^000000",
		"[Lv 2] ^777777ATK 900%^000000",
		"[Lv 3] ^777777ATK 1000%^000000",
		"[Lv 4] ^777777ATK 1100%^000000",
		"[Lv 5] ^777777ATK 1200%^000000",
		"[Lv 6] ^777777ATK 1300%^000000",
		"[Lv 7] ^777777ATK 1400%^000000",
		"[Lv 8] ^777777ATK 1500%^000000",
		"[Lv 9] ^777777ATK 1600%^000000",
		"[Lv 10] ^777777ATK 1700%^000000",
	},
	[SKID.RK_DEATHBOUND] = {
		"Death Bound",
		"Max Level: 10",
	...
	[SKID.GC_COUNTERSLASH] = {
		...
		"Skill Form: ^777777Active / Buff^000000",
		"Description: ^777777Can be used while the Weapon Blocking counter is active. Deals damage to all targets in a 3x3 area around the caster.",
		...
		"[Lv 5] ^777777ATK 1050%^000000",
		"[Lv 6] ^777777ATK 1200%^000000",
		"[Lv 7] ^777777ATK 1350%^000000",
		"[Lv 8] ^777777ATK 1500%^000000",
		"[Lv 9] ^777777ATK 1650%^000000",
		"[Lv 10] ^777777ATK 1800%^000000",
	},
	[SKID.GC_WEAPONCRUSH] = {
		"Weapon Crush ",
		"Max Level: 5",
		"^777777Skill Requirement: Weapon Blocking 1^000000",
		"Skill Form: ^777777Active / Debuff^000000",
		"Description: ^777777Allows to counter-attack an enemy after successfully defending against their attack with Weapon Blocking. Forcefully disarms the target. Duration and success rate increase with the skill level. ^000000",
	},
	...
	[SKID.AB_JUDEX] = {
		...
		"Description: ^777777A magic attack that deals Holy attribute damage to a target and all the enemies in the surrounding 3 cells. The damage dealt increases with the caster's Base Level. ^000000",
	...
	[SKID.AB_LAUDAAGNUS] = {
		...
		"Description: ^777777Recover Freezing, Stone Curse and Blind of all party members. VIT bonus when casting on normal condition party member.^000000",
	...
	[SKID.AB_LAUDARAMUS] = {
		...
		"Skill Form: ^777777Recovery^000000",
		"Description: ^777777Cures the status effects Silence, Sleep and Stun from all party members. LUK bonus when casting on normal condition party member.",
		"[Lv 1] ^777777Success Rate 50%^000000",
		"[Lv 2] ^777777Success Rate 60%^000000",
		"[Lv 3] ^777777Success Rate 70%^000000",
		"[Lv 4] ^777777Success Rate 80%^000000"
	...
	[SKID.AB_RENOVATIO] = {
		...
		"Skill Form: ^777777Heal^000000",
		"Description: ^777777Recovers a certain amount of HP to the caster and members of their party on the screen every 5 sec.^000000",
		"[Lv 1] ^777777Recovers 5% of HP every 5 sec. for 90 sec.^000000",
		"[Lv 2] ^777777Recovers 6% of HP every 5 sec. for 120 sec.^000000",
		"[Lv 3] ^777777Recovers 7% of HP every 5 sec. for 150 sec.^000000",
		"[Lv 4] ^777777Recovers 8% of HP every 5 sec. for 180 sec.^000000",
	},
	...
	[SKID.AB_CLEARANCE] = {
		...
		"Description: ^777777Removes most of buffs, debuffs and",
		"status effects from selected party member",
		"or monster.^000000",
	...
	[SKID.WL_FREEZE_SP] = {
		...
		"Skill Form: ^777777Passive^000000",
		"Description: ^777777Increases the slots available to Reading Spell Book. The number and type of spells that can be frozen depends on the caster's level and INT. Frozen spells slowly drain SP. The amount of SP drained depends on the number and type of the spells.^000000",
	},
	[SKID.RA_ARROWSTORM] = {
		"Arrow Storm",
		"Max Level: 10",
	...
	[SKID.RA_AIMEDBOLT] = {
		...
		"Skill Form: ^777777Active / Damage^000000",
		"Description: ^777777Shoots an arrow at the target dealing a lot of damage. The number of attacks is determined by the target's size. Small target: 2-3 attacks. Medium target: 3-4 attacks. Big target: 4-5 attacks.",
		"The skill fails if the caster doesn't have enough arrows. The damage is additionally increased according to the caster's Base Level.^000000",
		"[Lv 1] ^777777 ATK 520% x ??? times^000000",
		"[Lv 2] ^777777 ATK 540% x ??? times^000000",
		"[Lv 3] ^777777 ATK 560% x ??? times^000000",
		"[Lv 4] ^777777 ATK 580% x ??? times^000000",
		"[Lv 5] ^777777 ATK 600% x ??? times^000000",
		"[Lv 6] ^777777 ATK 620% x ??? times^000000",
		"[Lv 7] ^777777 ATK 640% x ??? times^000000",
		"[Lv 8] ^777777 ATK 660% x ??? times^000000",
		"[Lv 9] ^777777 ATK 680% x ??? times^000000",
		"[Lv 10] ^777777 ATK 700% x ??? times^000000",
	},
	[SKID.RA_DETONATOR] = {
		"Detonator",
		"Max Level: 1",
	...
	[SKID.WM_SEVERE_RAINSTORM] = {
		...
		"Skill Form: ^777777Active / Damage^000000",
		"Description: ^777777Activated using arrows, whips and musical instruments. Rains down arrows on enemies in an 11x11 area. Damage increases according to the caster's Base Level, AGI and DEX.",
		"Consumes 20 arrows. If the character doesn't have enough arrows, the skill fails.",
		"Increased damage when using whips or musical instruments.^000000",
		"[Lv 1] ^7777771 attack every 0.3 sec. / 0.9 sec. duration^000000",
		"[Lv 2] ^7777771 attack every 0.3 sec. / 1.5 sec. duration^000000",
		"[Lv 3] ^7777771 attack every 0.3 sec. / 2.1 sec. duration^000000",
		"[Lv 4] ^7777771 attack every 0.3 sec. / 2.7 sec. duration^000000",
		"[Lv 5] ^7777771 attack every 0.3 sec. / 3.0 sec. duration^000000",
	},
	...
	[SKID.MH_SUMMON_LEGION] = {
		"Call Legion",
		"Max Level: 5",
		"Description: ^777777 Summon a group of bugs to attack a targeted enemy.",
		"More powerful insect swarms are summoned based on the level of the skill.^000000",
		" [Lv 1] ^777777 Summon 3 Hornet / Duration 20 seconds ^000000",
		" [Lv 2] ^777777 Summon 3 Giant Hornet / Duration 30 seconds ^000000",
		" [Lv 3] ^777777 Summon 4 Giant Hornet / Duration 40 seconds ^000000",
		" [Lv 4] ^777777 Summon 4 Luciola Vespa / Duration 50 seconds ^000000",
		" [Lv 5] ^777777 Summon 5 Luciola Vespa / Duration 60 seconds ^000000"
	},
	[SKID.MH_NEEDLE_OF_PARALYZE] = {
		"Needle Of Paralyze",
		"Max Level: 10",
		"Description: ^777777 Deals poison property damage on the targeted enemy and causes [Paralyze] status.",
		"Paralyzed enemies cannot move and have decreased Defenses.",
		"[Paralyze] duration can be reduced by target's VIT and LUK.",
		"Chance of [Paralyze] increases in proportion to your skill's level ^000000",
		" [Lv 1] ^777777 Physical ATK 600% ^000000",
		" [Lv 2] ^777777 Physical ATK 800% ^000000",
		" [Lv 3] ^777777 Physical ATK 1000% ^000000",
		" [Lv 4] ^777777 Physical ATK 1200% ^000000",
		" [Lv 5] ^777777 Physical ATK 1400% ^000000",
		" [Lv 6] ^777777 Physical ATK 1600% ^000000",
		" [Lv 7] ^777777 Physical ATK 1800% ^000000",
		" [Lv 8] ^777777 Physical ATK 2000% ^000000",
		" [Lv 9] ^777777 Physical ATK 2200% ^000000",
		" [Lv 10] ^777777 Physical ATK 2400% ^000000"
	},
	[SKID.MH_POISON_MIST] = {
		"Poison Mist",
		"Max Level: 5",
		"Description: ^777777 Spread poison mist on a certain area, which causes [Blind] status and constant poison property damage to",
		"enemies inside. Chance of [Blind] increases in proportion to your skill's level.",
		"Only 1 Poison Mist can be active at a time.^000000",
		" [Lv 1] ^777777 Duration 12 seconds ^000000",
		" [Lv 2] ^777777 Duration 14 seconds ^000000",
		" [Lv 3] ^777777 Duration 16 seconds ^000000",
		" [Lv 4] ^777777 Duration 18 seconds ^000000",
		" [Lv 5] ^777777 Duration 20 seconds ^000000"
	},
	[SKID.MH_PAIN_KILLER] = {
		"Pain Killer",
		"Max Level: 10",
		"Description: ^777777 Inject a paralyzing poison to 1 selected ally, bestowing [Endure] effect and reducing the damage received.",
		"Also decreases attack speed as a side effect.^000000",
		" [Lv 1] ^777777 Duration 30 seconds ^000000",
		" [Lv 2] ^777777 Duration 40 seconds ^000000",
		" [Lv 3] ^777777 Duration 50 seconds ^000000",
		" [Lv 4] ^777777 Duration 60 seconds ^000000",
		" [Lv 5] ^777777 Duration 70 seconds ^000000",
		" [Lv 6] ^777777 Duration 80 seconds ^000000",
		" [Lv 7] ^777777 Duration 90 seconds ^000000",
		" [Lv 8] ^777777 Duration 100 seconds ^000000",
		" [Lv 9] ^777777 Duration 110 seconds ^000000",
		" [Lv 10] ^777777 Duration 120 seconds ^000000"
	},
	[SKID.MH_LIGHT_OF_REGENE] = {
		"Light Of Regenerate",
		"Max Level: 5",
		"Description: ^777777 Homunculus casts Light of Regenerate effect on its owner. When the owner dies during the duration,",
		"it sacrifices itself to resurrect the owner automatically. Intimacy of the Homunculus reduces after skill activation.",
		"If the player is carrying at least one Token of Siegfried, its effect will take priority over this skill.",
		"HP after resurrection depends on used skill level. ^000000",
	...
	[SKID.MH_OVERED_BOOST] = {
		"Over Boost",
		"Max Level: 5",
		"Description: ^777777 Temporarily fixing Homunculus and master's Flee rate and Attack speed, Defense decrease to 1/2.",
		"But, no other Flee Rate or Attack speed changing effect is possible during this skill's duration.",
		"After the duration lowers the Homunculus' hunger and drains the master's SP by 50% of the maximum.",
	...
	[SKID.MH_ERASER_CUTTER] = {
		"Eraser Cutter",
		"Max Level: 10",
		"Description: ^777777 Creates a sonic blade to attack one enemy many times.",
		"Deals magical damage to the target with Neutral property. ^000000",
		" [Lv 1] ^777777 MATK 900% ^000000",
		" [Lv 2] ^777777 MATK 1100% ^000000",
		" [Lv 3] ^777777 MATK 1300% ^000000",
		" [Lv 4] ^777777 MATK 1500% ^000000",
		" [Lv 5] ^777777 MATK 1700% ^000000",
		" [Lv 6] ^777777 MATK 1900% ^000000",
		" [Lv 7] ^777777 MATK 2100% ^000000",
		" [Lv 8] ^777777 MATK 2300% ^000000",
		" [Lv 9] ^777777 MATK 2500% ^000000",
		" [Lv 10] ^777777 MATK 2700% ^000000"
	},
	[SKID.MH_XENO_SLASHER] = {
		"Xeno Slasher",
		"Max Level: 10",
		"Description: ^777777 Wide range Magical Attack with Wind property.",
		"Low rate curse : Bleeding to all damaged targets. ^000000",
		" [Lv 1] ^777777 MATK 500% / 3  x 3 Cells ^000000",
		" [Lv 2] ^777777 MATK 800% / 3 x 3 Cells ^000000",
		" [Lv 3] ^777777 MATK 1100% / 3 x 3 Cells ^000000",
		" [Lv 4] ^777777 MATK 1400% / 5 x 5 Cells ^000000",
		" [Lv 5] ^777777 MATK 1700% / 5 x 5 Cells ^000000",
		" [Lv 6] ^777777 MATK 2000% / 5 x 5 Cells ^000000",
		" [Lv 7] ^777777 MATK 2300% / 7 x 7 Cells ^000000",
		" [Lv 8] ^777777 MATK 2600% / 7 x 7 Cells ^000000",
		" [Lv 9] ^777777 MATK 2900% / 7 x 7 Cells ^000000",
		" [Lv 10] ^777777 MATK 3200% / 9 x 9 Cells ^000000"
	},
	[SKID.MH_SILENT_BREEZE] = {
		"Silent Breeze",
		"Max Level: 5",
		"Description: ^777777 Wind of Silence. Restore a certain amount of HP to one target. Causes Silence effent to",
		"the target preventing it from casting skills. This skill will also remove certain bad status effects.",
		"Success rate is doubled when casting on an ally. ^000000",
	...
	[SKID.MH_STAHL_HORN] = {
		"Stahl Horn",
		"Max Level: 10",
		"Description: ^777777 Rush against 1 target to deal damage,",
		"knock it back 1 Cell and cause Stun effect.",
		"Chance of [Stun] increases in proportion to your skill's level.",
		"Increases damage based on Homunculus's base level. ^000000",
		" [Lv 1] ^777777 ATK 1100% / Casting Range 5 Cells ^000000",
		" [Lv 2] ^777777 ATK 1200% / Casting Range 5 Cells ^000000",
		" [Lv 3] ^777777 ATK 1300% / Casting Range 6 Cells ^000000",
		" [Lv 4] ^777777 ATK 1400% / Casting Range 6 Cells ^000000",
		" [Lv 5] ^777777 ATK 1500% / Casting Range 7 Cells ^000000",
		" [Lv 6] ^777777 ATK 1600% / Casting Range 7 Cells ^000000",
		" [Lv 7] ^777777 ATK 1700% / Casting Range 8 Cells ^000000",
		" [Lv 8] ^777777 ATK 1800% / Casting Range 8 Cells ^000000",
		" [Lv 9] ^777777 ATK 1900% / Casting Range 9 Cells ^000000",
		" [Lv 10] ^777777 ATK 2000% / Casting Range 9 Cells ^000000"
	},
	[SKID.MH_GOLDENE_FERSE] = {
		"Goldene Ferse",
		"Max Level: 5",
		"Description: ^777777 Increases Homumculus' Flee Rate and Attack Speed, normal attacks have a chance",
		"to deal Holy property damage. During the effect duration [Stahl Horn] will deal holy property damage.",
		"Chance of Holy property damage increases in proportion to your skill's level.",
		"This skill cannot be casted along with [Angriffs Modus] skill. ^000000",
		" [Lv 1] ^777777 Flee Rate 20 / Attack Speed 10% Increase / Duration 30 seconds ^000000",
		" [Lv 2] ^777777 Flee Rate 30 / Attack Speed 14% Increase / Duration 45 seconds ^000000",
		" [Lv 3] ^777777 Flee Rate 40 / Attack Speed 18% Increase / Duration 60 seconds ^000000",
		" [Lv 4] ^777777 Flee Rate 50 / Attack Speed 22% Increase / Duration 75 seconds ^000000",
		" [Lv 5] ^777777 Flee Rate 60 / Attack Speed 26% Increase / Duration 90 seconds ^000000"
	},
	[SKID.MH_STEINWAND] = {
		"Stein Wand",
		"Max Level: 5",
	...
	[SKID.MH_HEILIGE_STANGE] = {
		"Heilige Stange",
		"Max Level: 10",
		"Description: ^777777 Deals Holy property magic damage to 1 target and all enemies in range.",
		"Increases damage based on Homunculus's base level. ^000000",
		" [Lv 1] ^777777 MATK 750% / 3 x 3 Cells ^000000",
		" [Lv 2] ^777777 MATK 1000% / 3 x 3 Cells ^000000",
		" [Lv 3] ^777777 MATK 1250% / 3 x 3 Cells ^000000",
		" [Lv 4] ^777777 MATK 1500% / 3 x 3 Cells ^000000",
		" [Lv 5] ^777777 MATK 1750% / 5 x 5 Cells ^000000",
		" [Lv 6] ^777777 MATK 2000% / 5 x 5 Cells ^000000",
		" [Lv 7] ^777777 MATK 2250% / 5 x 5 Cells ^000000",
		" [Lv 8] ^777777 MATK 2500% / 5 x 5 Cells ^000000",
		" [Lv 9] ^777777 MATK 2750% / 7 x 7 Cells ^000000",
		" [Lv 10] ^777777 MATK 3000% / 7 x 7 Cells ^000000"
	},
	[SKID.MH_ANGRIFFS_MODUS] = {
		"Angriffs Modus",
		"Max Level: 5",
		"Description: ^777777 Increases Homunculus' ATK for certain period while greatly lowering",
		"Defense and Flee Rate. This skill cannot be casted along with [Goldene Ferse] skill.^000000",
		" [Lv 1] ^777777 ATK +70  / Defense -50  / Flee -35 / Duration 30 seconds ^000000",
		" [Lv 2] ^777777 ATK +90  / Defense -70 / Flee -45 / Duration 45 seconds ^000000",
		" [Lv 3] ^777777 ATK +110 / Defense -90 / Flee -55 / Duration 60 seconds ^000000",
		" [Lv 4] ^777777 ATK +130 / Defense -110 / Flee -65 / Duration 75 seconds ^000000",
		" [Lv 5] ^777777 ATK +150 / Defense -130 / Flee -75 / Duration 90 seconds ^000000"
	},
	[SKID.MH_STYLE_CHANGE] = {
		"Style Change",
		"Max Level: 1",
		"Description: ^777777 Changes the Homunculus' between Fighter and Grappler style.",
		"When attacking or taking damage during Fighter style, adds a chance to gathers Spirit Spheres. ^000000"
	},
	[SKID.MH_SONIC_CRAW] = {
		"Sonic Claw",
		"Max Level: 5",
		"Description: ^777777 Can only be used while in Fighter style. Activates a high speed claw attack to 1 targeted enemy.",
		"Attacks as many times as currently active Spirit Spheres. Can not be used without at least one Spirit Sphere.^000000",
	...
	[SKID.MH_SILVERVEIN_RUSH] = {
		"Silvervein Rush",
		"Max Level: 10",
		"Description: ^777777 Can only be used while in Fighter style after using Sonic Claw.",
		"Consumes 1 Spirit Sphere when casting the skill. Deals damage and has a chance to cause [Stun] effect on the target.",
		"Chance of [Stun] effect increases in proportion to your skill's level.",
		"Increases damage based on Homunculus' base level. ^000000",
		" [Lv 1] ^777777 ATK 200% ^000000",
		" [Lv 2] ^777777 ATK 400% ^000000",
		" [Lv 3] ^777777 ATK 600% ^000000",
		" [Lv 4] ^777777 ATK 800% ^000000",
		" [Lv 5] ^777777 ATK 1000% ^000000",
		" [Lv 6] ^777777 ATK 1200% ^000000",
		" [Lv 7] ^777777 ATK 1400% ^000000",
		" [Lv 8] ^777777 ATK 1600% ^000000",
		" [Lv 9] ^777777 ATK 1800% ^000000",
		" [Lv 10] ^777777 ATK 2000% ^000000"
	},
	[SKID.MH_MIDNIGHT_FRENZY] = {
		"Midnight Frenzy",
		"Max Level: 10",
		"Description: ^777777 Can only be used while in Fighter style after using Silvervein Rush.",
		"Consumes 2 Spirit Spheres when casting the skill. Deals damage and has a chance to cause [Fear] on the target.",
		"The chance to cause [Fear] is increased based on the amount of Spheres active.",
		"Enemies under the [Fear] status can't move for 2 seconds and have reduced FLEE and HIT.",
		"Sonic Claw can be used after this skill. Increases damage based on Homunculus's base level.^000000^000000",
		" [Lv 1] ^777777 ATK 300% ^000000",
		" [Lv 2] ^777777 ATK 600% ^000000",
		" [Lv 3] ^777777 ATK 900% ^000000",
		" [Lv 4] ^777777 ATK 1200% ^000000",
		" [Lv 5] ^777777 ATK 1500% ^000000",
		" [Lv 6] ^777777 ATK 1800% ^000000",
		" [Lv 7] ^777777 ATK 2100% ^000000",
		" [Lv 8] ^777777 ATK 2400% ^000000",
		" [Lv 9] ^777777 ATK 2700% ^000000",
		" [Lv 10] ^777777 ATK 3000% ^000000"
	},
	[SKID.MH_TINDER_BREAKER] = {
		"Tinder Breaker",
		"Max Level: 5",
		"Description: ^777777 Can only be used while in Grappler style.",
		"Approach the target and break its joints. After the skill target and Homunculus",
		"cannot move and each other's Flee Rate becomes 0. Consumes 1 Spirit Sphere",
		"when casting the skill. ATK and grapple time increases based on Homunculus' STR stat.^000000",
	...
	[SKID.MH_CBC] = {
		...
		"Max Level: 5",
		"Description: ^777777 Can only be used while in Grappler style after using Tinder Breaker. Consumes 1 Spirit Spheres when casting the skill.",
		"Constantly reduce target's SP, while draining Health. On monsters the skill drains additional health instead of SP.",
		"Homunculus and target cannot move during skill duration and Flee Rate becomes 0.",
		"Duration increases based on Homunculus's STR. ^000000",
	...
	[SKID.MH_EQC] = {
		...
		"Max Level: 5",
		"Description: ^777777 Can only be used while in Grappler style after using C.B.C. Consumes 2 Spirit Spheres when casting the skill.",
		"Causes [Stun] on the target and deals damage. Also reduces MHP, ATK, and Defense.",
		"After using this skill Homunculus and target are able to move again and Flee Rate is restored.",
		"This skill cannot be used on boss monsters. ^000000",
	...
	[SKID.MH_MAGMA_FLOW] = {
		"Magma Flow",
		"Max Level: 5",
		"Description: ^777777 Activates a chance to erupt magma every time the Homunculus takes damage.",
		"The magma deals Fire property damage to all enemies around the Homunculus.",
		"Chance of activation increases in proportion to your skill's level.",
		"Damage is increased based on the Homunculus' level.^000000",
		" [Lv 1] ^777777 ATK 100% /  Range 3 x 3  ^000000",
		" [Lv 2] ^777777 ATK 200% /  Range 3 x 3  ^000000",
		" [Lv 3] ^777777 ATK 300% /  Range 3 x 3  ^000000",
		" [Lv 4] ^777777 ATK 400% /  Range 5 x 5  ^000000",
		" [Lv 5] ^777777 ATK 500% /  Range 5 x 5  ^000000"
	},
	[SKID.MH_GRANITIC_ARMOR] = {
		"Granitic Armor",
		"Max Level: 5",
		"Description: ^777777 Create a granite based strong armor, which temporarily decreases the damage",
		"taken by the Homunculs and its master. When the effect ends it consumes a certain amount of HP",
		"Effect lasts for 60 seconds. ^000000",
	...
	[SKID.MH_LAVA_SLIDE] = {
		"Lava Slide",
		"Max Level: 10",
		"Description: ^777777 Spray down lava on the ground, to deal damage to all enemies in its range. All targets",
		"taking damage have a chance to receive the [Burning] effect. Chance of [Burning] effect increases in proportion to your skill's level.^000000",
		" [Lv 1] ^777777 Duration 8 seconds / 3 x 3 Cells ^000000",
		" [Lv 2] ^777777 Duration 10 seconds / 3 x 3 Cells ^000000",
		" [Lv 3] ^777777 Duration 12 seconds / 3 x 3 Cells ^000000",
		" [Lv 4] ^777777 Duration 14 seconds / 5 x 5 Cells ^000000",
		" [Lv 5] ^777777 Duration 16 seconds / 5 x 5 Cells ^000000",
		" [Lv 6] ^777777 Duration 18 seconds / 5 x 5 Cells ^000000",
		" [Lv 7] ^777777 Duration 20 seconds / 7 x 7 Cells ^000000",
		" [Lv 8] ^777777 Duration 22 seconds / 7 x 7 Cells ^000000",
		" [Lv 9] ^777777 Duration 24 seconds / 7 x 7 Cells ^000000",
		" [Lv 10] ^777777 Duration 26 seconds / 9 x 9 Cells ^000000"
	},
	[SKID.MH_PYROCLASTIC] = {
		"Pyroclastic",
		"Max Level: 10",
		"Description: ^777777 Temporarily changes Homunculus' attack and master's weapon's attack to Fire property",
		"and increases ATK. When attacking, there's also a chance to cast [Hammerfall] automatically.",
		"ATK gained increases based on Homumculus' level.^000000",
		" [Lv 1] ^777777 Duration 60 seconds^000000",
		" [Lv 2] ^777777 Duration 80 seconds^000000",
		" [Lv 3] ^777777 Duration 100 seconds^000000",
		" [Lv 4] ^777777 Duration 120 seconds^000000",
		" [Lv 5] ^777777 Duration 140 seconds^000000",
		" [Lv 6] ^777777 Duration 160 seconds^000000",
		" [Lv 7] ^777777 Duration 180 seconds^000000",
		" [Lv 8] ^777777 Duration 200 seconds^000000",
		" [Lv 9] ^777777 Duration 220 seconds^000000",
		" [Lv 10] ^777777 Duration 240 seconds^000000"
	},
	[SKID.MH_VOLCANIC_ASH] = {
		"Volcanic Ash",
		"Max Level: 5",
		"Description: ^777777 Spray volcanic ashes on the ground, which cause the [Ash] status effect to all enemies in the skill's range.",
		"Targets affected by the [Ash] effect will loose 50 HIT and have a high chance to fail casting skills.",
		"They will also take additional Fire property damage. Plant type monsters will have their defense",
		"lowered by 50% and Water type monsters will loose 50% of their ATK and Flee.",
		"Volcanic Ash effect's duration increases based on skill level. Up to 3 Volcanic Ash can be active at the same time.^000000",
		" [Lv 1] ^777777 Effect duration 12 seconds ^000000",
		" [Lv 2] ^777777 Effect duration 14 seconds ^000000",
		" [Lv 3] ^777777 Effect duration 16 seconds ^000000",
		" [Lv 4] ^777777 Effect duration 18 seconds ^000000",
		" [Lv 5] ^777777 Effect duration 20 seconds ^000000"
	},
	[SKID.KO_YAMIKUMO] = {
		"Shadow Hiding",
		"Max Level: 1",
	...
	[SKID.KO_JYUMONJIKIRI] = {
		...
		"Oboro. Enemies with Cross Slash damage will fall",
		"into a <Cross Wound> state for about 3 seconds.",
		"Attacking an enemy under the <Cross Wound> effect",
		"with Cross Slash again will inflict a lot more",
		"damage.",
	...
	[SKID.KO_HUUMARANKA] = {
		...
		"Description: Throw your Huuma Shuriken to inflict",
		"damage on all enemies within a 7 x 7 cells range.",
		"The higher [Ninja skill: Throw Huuma Shuriken]",
		"level and DEX / AGI of the caster, the more damage",
		"this skill will do.",
		"Must be equipped with a Huuma Shuriken",
	...
	[SKID.KO_MEIKYOUSISUI] = {
		...
		"When you receive damage in this state,",
	...
	[SKID.KO_JYUSATSU] = {
		...
		"Description: Casts a life-stealing illusion on the",
		"target that also causes [Curse] effect.",
		"Has a low chance to cause [Coma] on lower level",
		"players. Does not affect monsters."
	},
	[SKID.KO_GENWAKU] = {
		"Illusion - Bewitch",
		"Max Level: 5 ",
	...
	[SKID.OB_OBOROGENSOU] = {
		...
		"Description: Either randomly heals or",
		"drains HP and SP depending on the",
		"target's current HP and SP. ",
		"Targets under the Moonlight Fantasy will",
		"spread the magic damage they receive to",
		"surrounding targets.",
	...
	[SKID.RL_FALLEN_ANGEL] = {
		...
		"^777777Jump to a selected spot and increase Desperado damage by 100% for 2 seconds after landing.^000000",
	...
	[SKID.RL_S_STORM] = {
		...
		"^777777Inflict damage on a target and surrounding enemies within a 5x5 cell area, and destroy a Headgear equipped to the target.^000000",
	...
	[SKID.RL_FIREDANCE] = {
		...
		"Max Lv.: 5",
		"^777777Prerequisite: Desperado Lv. 1^000000",
		"Class: ^777777Attack^000000",
		"Description: ^777777A Revolver skill.^000000",
		"^777777Attack all enemies within a 5x5 cell area around you. This skill's damage increases in proportion to your Level and the skill's level.^000000",
	...
	[SKID.RL_BANISHING_BUSTER] = {
		...
		"Class: ^777777Attack/Special^000000",
		"Description: ^777777A Shotgun skill.^000000",
		"^777777Inflict damage on a single target, and dispell the target.^000000",
		"^777777Consumes 1 Bullet.^000000",
	...
	[SKID.RL_AM_BLAST] = {
		...
		"Max Lv.: 5",
		"^777777Prerequisite: Mass Spiral Lv. 1^000000",
		"Class: ^777777Attack/Special^000000",
		"Description: ^777777A Rifle skill.^000000",
		"^777777Inflict damage and reduce the target's Player Resistance.^000000",
		"^777777This skill's chance increases in proportion to your Dexterity and the skill's level.^000000",
		"[Level 1]: ^777777Lasts for 6 sec./Resistance -10%/Chance 30%^000000",
		"[Level 2]: ^777777Lasts for 7 sec./Resistance -20%/Chance 40%^000000",
		"[Level 3]: ^777777Lasts for 8 sec./Resistance -30%/Chance 50%^000000",
		"[Level 4]: ^777777Lasts for 9 sec./Resistance -40%/Chance 60%^000000",
		"[Level 5]: ^777777Lasts for 10 sec./Resistance -50%/Chance 70%^000000"
	},
	[SKID.RL_QD_SHOT] = {
	...
	[SKID.RL_HEAT_BARREL] = {
		...
		"Max Lv.: 5",
		"^777777Prerequisite: Rich's Coin Lv. 1^000000",
		"Class: ^777777Supportive^000000",
	...
	[SKID.RL_SLUGSHOT] = {
		...
		"^777777Consumes 1 Slug Bullet from the inventory.^000000",
	...
	[SKID.RL_HAMMER_OF_GOD] = {
		...
		"^777777If the target is Crimson Marked, this skill attacks target and 5x5 cells around the target.^000000",
		...
		"^777777Targets with [Crimson Marker] additionally receive 100% damage, targets without it - 10%.^000000",
	...
	[SKID.RL_B_TRAP] = {
		...
		"Max Lv.: 5",
		"^777777Prerequisite: Flicker Lv. 1^000000",
	...
	[SKID.SU_BASIC_SKILL] = {
		...
		"Description: ^777777Learn how to use basic interface skills.^000000",
	...
	[SKID.SU_BITE] = {
		...
		"Class: ^777777Attack^000000",
		"Target: ^777777Enemy^000000",
		"Description: ^777777Bite of Enemy. More attack effect when the enemy is weakened.^000000",
		"^7777771 Extra skill activation when BaseLv is higher than 30. Activation chanse increase each 30 BaseLv up.^000000",
		"[Lv 1]: ^777777ATK 200%.^000000"
	},
	[SKID.SU_HIDE] = {
		"[Hide]",
		...
		"Description: ^777777Hide in the bush, evade enemy attacks. Can be detected by enemy's search skill.^000000"
	},
	[SKID.SU_SCRATCH] = {
		"[Scratch]",
		"Max Level: 3",
		...
		"Class: ^777777Attack^000000",
		"Target: ^777777Enemy^000000",
		"Description: ^777777Scratch the target enemy, create an wound.has a chance of Bleeding the target.^000000",
		"^7777771 Extra skill activation when BaseLv is higher than 30. Activation chanse increase each 30 BaseLv up.^000000",
		"[Lv 1]: ^777777ATK 100%.^000000",
	...
	[SKID.SU_STOOP] = {
		...
		"Class: ^777777Support^000000",
		"Description: ^77777790% damage reduce during 6 seconds. Effect disappear when getting knockback.^000000"
	},
	[SKID.SU_LOPE] = {
		"[Lope]",
		"Max Level: 3",
		...
		"^777777After learning [Lope] guild skill [Urgent Call] casting time increase double time.^000000",
		"[Lv 1] ^777777Range: 6 cells.^000000",
		"[Lv 2] ^777777Range: 10 cells.^000000",
		"[Lv 3] ^777777Range: 14 cells.^000000"
	},
	[SKID.SU_SPRITEMABLE] = {
		"[Sprite Mable]",
		"Max Level: 1",
		...
		"Class: ^000099Passive^000000",
		"Description: ^777777Learn how to use spirits.^000000",
		"^777777MHP +1000, MSP +100.^000000",
		"^777777Able to use spirit of sea, spirit of land, and spirit of life.^000000"
	},
	[SKID.SU_FRESHSHRIMP] = {
		"[Fresh Shrimp]",
		"Max Level: 5",
		...
		"Description: ^777777Recover small HP during 2 minutes by absorbing small fresh shrimp's soul.^000000",
		"[Lv 1]: ^777777Every 10 seconds.^000000",
		"[Lv 2]: ^777777Every 9 seconds.^000000",
		"[Lv 3]: ^777777Every 8 seconds.^000000",
		"[Lv 4]: ^777777Every 7 seconds.^000000",
		"[Lv 5]: ^777777Every 6 seconds.^000000"
	},
	[SKID.SU_BUNCHOFSHRIMP] = {
		...
		"Description: ^77777710% ATK and MATK increase by the help from bunch of shrimps.^000000",
	...
	[SKID.SU_TUNABELLY] = {
		...
		"Class: ^777777Seafoods (Support)^000000",
		"Target: ^777777Self^000000",
		"Description: ^777777Recover certain amount of MHP by absorbing delicious Tuna Belly soul.^000000",
		"[Lv 1]: ^77777710% MHP.^000000",
		"[Lv 2]: ^77777730% MHP.^000000",
		"[Lv 3]: ^77777750% MHP.^000000",
		"[Lv 4]: ^77777770% MHP.^000000",
		"[Lv 5]: ^77777790% MHP.^000000"
	},
	[SKID.SU_TUNAPARTY] = {
		"[Tuna Party]",
		"Max Level: 5",
		...
		"[Lv 1]: ^777777Absorbs damage equal to 10% of character MHP.^000000",
		"[Lv 2]: ^777777Absorbs damage equal to 20% of character MHP.^000000",
		"[Lv 3]: ^777777Absorbs damage equal to 30% of character MHP.^000000",
		"[Lv 4]: ^777777Absorbs damage equal to 40% of character MHP.^000000",
		"[Lv 5]: ^777777Absorbs damage equal to 50% of character MHP.^000000"
	},
	[SKID.SU_SV_STEMSPEAR] = {
		...
		"^7777771 Extra skill activation when BaseLv is higher than 30. Activation chanse increase each 30 BaseLv up.^000000",
		"[Lv 1]: ^777777Earth magic / MATK 700% / bleeding chance.^000000",
		"[Lv 2]: ^777777Fire magic / MATK 700% / bleeding chance.^000000",
		"[Lv 3]: ^777777Water magic / MATK 700% / bleeding chance.^000000",
		"[Lv 4]: ^777777Wind magic / MATK 700% / bleeding chance.^000000",
		"[Lv 5]: ^777777Ghost magic / MATK 700% / bleeding chance.^000000"
	},
	[SKID.SU_SV_ROOTTWIST] = {
		...
		"^777777Effect deactivates by [Heaven's Drive] and [Trample]. Cannot be used to Boss monsters.^000000",
		"[Lv 1]: ^777777Duration: 7 seconds.^000000",
		"[Lv 2]: ^777777Duration: 9 seconds.^000000",
		"[Lv 3]: ^777777Duration: 11 seconds.^000000",
		"[Lv 4]: ^777777Duration: 13 seconds.^000000",
		"[Lv 5]: ^777777Duration: 15 seconds.^000000"
	},
	[SKID.SU_CN_METEOR] = {
		"[CN Meteor]",
		"Max Level: 5",
		...
		"Class: ^777777Vegetable (ATK)^000000",
		"Target: ^777777Enemy^000000",
		"Description: ^777777Summon giant Nepeta's soul and drop to attack area. More Nepeta drops based on character level.^000000",
		"^777777By using 1 Nepeta Cataria, the chance of curse will increase.^000000",
		"[Lv 1]: ^777777Neutral magic / 3 x 3 cells / MATK 300%.^000000",
		"[Lv 2]: ^777777Neutral magic / 3 x 3 cells / MATK 400%.^000000",
		"[Lv 3]: ^777777Neutral magic / 5 x 5 cells / MATK 500%.^000000",
		"[Lv 4]: ^777777Neutral magic / 5 x 5 cells / MATK 600%.^000000",
		"[Lv 5]: ^777777Neutral magic / 7 x 7 cells / MATK 700%.^000000"
	},
	[SKID.SU_CN_POWDERING] = {
		...
		"Class: ^777777Vegetable (Support)^000000",
		"Target: ^777777Enemy^000000",
		"Description: ^777777Where Nepeta powder spreaded, 50% ATK and MATK decrease for certain time, movement speed also decrease.^000000",
		"^777777Huge increase of HP and SP natural recovery rate.^000000",
		"^777777Need 1 Nepeta Cataria.^000000",
		"[Lv 1]: ^7777773 x 3 cells / duration: 3 seconds.^000000",
		"[Lv 2]: ^7777773 x 3 cells / duration: 4 seconds.^000000",
		"[Lv 3]: ^7777775 x 5 cells / duration: 5 seconds.^000000",
		"[Lv 4]: ^7777775 x 5 cells / duration: 6 seconds.^000000",
		"[Lv 5]: ^7777777 x 7 cells / duration: 7 seconds.^000000"
	},
	[SKID.SU_PICKYPECK] = {
		"[Picky Peck]",
		"Max Level: 5",
		...
		"Target: ^777777Enemy^000000",
		"Description: ^777777Angry Picky's soul shoots the enemy. Doubled damaged when enemy HP is lower than 50%.^000000",
		"^7777771 Extra skill activation when BaseLv is higher than 30. Activation chanse increase each 30 BaseLv up.^000000",
		"[Lv 1]: ^777777Long-range physical damage / ATK 300%.^000000",
		"[Lv 2]: ^777777Long-range physical damage / ATK 400%.^000000",
		"[Lv 3]: ^777777Long-range physical damage / ATK 500%.^000000",
		"[Lv 4]: ^777777Long-range physical damage / ATK 600%.^000000",
		"[Lv 5]: ^777777Long-range physical damage / ATK 700%.^000000"
	},
	[SKID.SU_ARCLOUSEDASH] = {
		...
		"Target: ^777777Self^000000",
		"Description: ^777777Absorb the soul of Arclouze and become more quick. If target is Doram (including user), 10% additional long-range physical damage increase.^000000",
		"[Lv 1]: ^777777For 60 seconds AGI +20 / movement speed increase.^000000",
		"[Lv 2]: ^777777For 70 seconds AGI +25 / movement speed increase.^000000",
		"[Lv 3]: ^777777For 80 seconds AGI +30 / movement speed increase.^000000",
		"[Lv 4]: ^777777For 90 seconds AGI +35 / movement speed increase.^000000",
		"[Lv 5]: ^777777For 100 seconds AGI +40 / movement speed increase.^000000"
	},
	[SKID.SU_SCAROFTAROU] = {
		"[Scar of Tarou]",
		"Max Level: 5",
		...
		"Class: ^777777Animal (ATK)^000000",
		"Target: ^777777Enemy^000000",
		"Description: ^777777Country mouse's wounded soul attacks enemy the same way.^000000",
		"^777777Enables [Bitten scar] effect that drains MHP regularly for 9 seconds. Effect strength depends on DEX and skill level.^000000",
		"^777777Effect deactivates by [Heal], [Cure], [Clearance]. Cannot cast debuff on boss monsters, but attack rate gets doubled.^000000",
		"^7777771 Extra skill activation when BaseLv is higher than 30. Activation chanse increase each 30 BaseLv up.^000000",
		"[Lv 1]: ^777777ATK 100% / [Bitten scar]: certain amount of MHP draing for 9 seconds.^000000",
		"[Lv 2]: ^777777ATK 200% / [Bitten scar]: certain amount of MHP draing for 9 seconds.^000000",
		"[Lv 3]: ^777777ATK 300% / [Bitten scar]: certain amount of MHP draing for 9 seconds.^000000",
		"[Lv 4]: ^777777ATK 400% / [Bitten scar]: certain amount of MHP draing for 9 seconds.^000000",
		"[Lv 5]: ^777777ATK 500% / [Bitten scar]: certain amount of MHP draing for 9 seconds.^000000"
	},
	[SKID.SU_LUNATICCARROTBEAT] = {
		...
		"Class: ^777777Animal (ATK)^000000",
		"Target: ^777777Enemy^000000",
		"Description: ^777777Lunatic soul's anger becomes a rain of carrot attack.^000000",
		"^777777When using 1 Carrot, chance of stun effect will increase.^000000",
		"[Lv 1]: ^777777ATK 300% / 3 x 3 cells.^000000",
		"[Lv 2]: ^777777ATK 400% / 3 x 3 cells.^000000",
		"[Lv 3]: ^777777ATK 500% / 5 x 5 cells.^000000",
		"[Lv 4]: ^777777ATK 600% / 5 x 5 cells.^000000",
		"[Lv 5]: ^777777ATK 700% / 7 x 7 cells.^000000"
	},
	[SKID.SU_POWEROFSEA] = {
		"[Power of Sea]",
		"Max Level: 1",
		...
		"Class: ^000099Passive^000000",
		"Description: ^777777Obtain the power of sea.^000000",
		"^777777Heal effectiveness +10%. If total level of [Seafood] class skills is 20 or higher, additionally increases heal effectiveness by 20%.^000000"
	},
	[SKID.SU_POWEROFLAND] = {
		"[Power of Land]",
		"Max Level: 1",
		...
		"Class: ^000099Passive^000000",
		"Description: ^777777Obtain the power of land.^000000",
		"^777777INT +20. If total level of [Vegetable] class skills is 20 or higher, additionally increases magic attack by 20%.^000000"
	},
	[SKID.SU_POWEROFLIFE] = {
		"[Power of Life]",
		"Max Level: 1",
		...
		"Class: ^000099Passive^000000",
		"Description: ^777777Obtain the power of life.^000000",
		"^777777FLEE +20, HIT +20, CRIT +20. If total level of [Animal] class skills is 20 or higher, additionally increases long-range physical damage by 20%.^000000"
	},
	[SKID.SU_SOULATTACK] = {
		"[Soul Attack]",
		"Max Level: 1",
		...
		"Class: ^000099Passive^000000",
		"Target: ^777777Enemy^000000",
		"Description: ^777777Raises the range of all normal attacks.^000000"
	},
	[SKID.SU_GROOMING] = {
		"[Grooming]",
		"Max Level: 5",
		...
		"^777777Curable status : Poison, Frozen, Stun, Sleep, Bleeding, Silence, Crystallization, Freezing, Deep sleep, Fear, effect of [Mandragora Howl].^000000",
		"^777777Increase FLEE for a while.^000000",
		"[Lv 1]: ^777777FLEE +100 / duration: 3 seconds.^000000",
		"[Lv 2]: ^777777FLEE +100 / duration: 4 seconds.^000000",
		"[Lv 3]: ^777777FLEE +100 / duration: 5 seconds.^000000",
		"[Lv 4]: ^777777FLEE +100 / duration: 6 seconds.^000000",
		"[Lv 5]: ^777777FLEE +100 / duration: 7 seconds.^000000"
	},
	[SKID.SU_PURRING] = {
		"[Purring]",
		"Max Level: 5",
		...
		"Description: ^777777Purring to heal everyone.^000000",
		"^777777Apply skill [Grooming] to all party members.^000000",
		"[Lv 1]: ^777777FLEE +100 / duration: 7 seconds.^000000",
		"[Lv 2]: ^777777FLEE +100 / duration: 9 seconds.^000000",
		"[Lv 3]: ^777777FLEE +100 / duration: 11 seconds.^000000",
		"[Lv 4]: ^777777FLEE +100 / duration: 13 seconds.^000000",
		"[Lv 5]: ^777777FLEE +100 / duration: 15 seconds.^000000"
	},
	[SKID.SU_SHRIMPARTY] = {
		"[Tasty Shrimp Party]",
		"Max Level: 5",
		...
		"Class: ^777777Seafoods (Support)^000000",
		"Target: ^777777All party member^000000",
		"Description: ^777777Apply skill [Fresh Shrimp] to all party members.^000000",
		"^777777Also using effect [Blessing of Shrimp] that receive 150% additional SP recovery.^000000",
		"[Lv 1]: ^777777Increase SP recovery during 12 seconds.^000000",
		"[Lv 2]: ^777777Increase SP recovery during 14 seconds.^000000",
		"[Lv 3]: ^777777Increase SP recovery during 16 seconds.^000000",
		"[Lv 4]: ^777777Increase SP recovery during 18 seconds.^000000",
		"[Lv 5]: ^777777Increase SP recovery during 20 seconds.^000000"
	},
	[SKID.SU_CHATTERING] = {
		"[Chattering]",
		"Max Level: 5",
		...
		"[Lv 1]: ^777777SP 50 consume.^000000",
		"[Lv 2]: ^777777SP 45 consume.^000000",
		"[Lv 3]: ^777777SP 40 consume.^000000",
		"[Lv 4]: ^777777SP 35 consume.^000000",
		"[Lv 5]: ^777777SP 30 consume.^000000"
	},
	[SKID.SU_MEOWMEOW] = {
		"[Meow Meow]",
		"Max Level: 5",
		...
		"Class: ^777777Vegetable (Support)^000000",
		"Target: ^777777All party member^000000",
		"Description: ^777777Awakening friend's hunt instinct by Chattering.^000000",
		"^777777Increase party member's, including player, ATK, MATK +100 and movement speed for a while.^000000",
		"[Lv 1]: ^777777Duration: 8 seconds / SP 100 consume.^000000",
		"[Lv 2]: ^777777Duration: 8 seconds / SP 90 consume.^000000",
		"[Lv 3]: ^777777Duration: 10 seconds / SP 80 consume.^000000",
		"[Lv 4]: ^777777Duration: 10 seconds / SP 70 consume.^000000",
		"[Lv 5]: ^777777Duration: 12 seconds / SP 60 consume.^000000"
	},
	[SKID.SU_NYANGGRASS] = {
		"[Nyang Grass]",
		"Max Level: 5",
		...
		"Class: ^777777Vegetable (Support)^000000",
		"Target: ^777777Enemy^000000",
		"Description: ^777777Neutralize enemy defense within the effect area.^000000",
		"^777777Reducing DEF and MDEF of players equipment to 0.^000000",
		"^777777Reducing DEF and MDEF of monsters to 50%.^000000",
		"[Lv 1]: ^7777775 x 5 cells / duration: 6 seconds.^000000",
		"[Lv 2]: ^7777775 x 5 cells / duration: 7 seconds.^000000",
		"[Lv 3]: ^7777777 x 7 cells / duration: 8 seconds.^000000",
		"[Lv 4]: ^7777777 x 7 cells / duration: 9 seconds.^000000",
		"[Lv 5]: ^7777779 x 9 cells / duration: 10 seconds.^000000"
	},
	[SKID.SU_HISS] = {
		"[Hiss]",
		"Max Level: 5",
		...
		"^777777Increase all party member's, including player, perfect dodge and movement speed.^000000",
		"[Lv 1]: ^777777Perfect dodge +50 for 3 seconds / increase movement speed for 3 seconds.^000000",
		"[Lv 2]: ^777777Perfect dodge +50 for 3 seconds / increase movement speed for 3 seconds.^000000",
		"[Lv 3]: ^777777Perfect dodge +50 for 3 seconds / increase movement speed for 4 seconds.^000000",
		"[Lv 4]: ^777777Perfect dodge +50 for 3 seconds / increase movement speed for 5 seconds.^000000",
		"[Lv 5]: ^777777Perfect dodge +50 for 3 seconds / increase movement speed for 6 seconds.^000000"
	},
	[SKID.SU_POWEROFFLOCK] = {
		...
		"Class: ^777777Animal (Support)^000000",
		"Target: ^777777Enemy^000000",
		"Description: ^777777Show how strong we are. Fear me!^000000",
		"^777777Cast [Fear] and [Freezing] within certain area.^000000",
		"[Lv 1]: ^7777777 x 7 cells around character.^000000",
		"[Lv 2]: ^7777779 x 9 cells around character.^000000",
		"[Lv 3]: ^77777711 x 11 cells around character.^000000",
		"[Lv 4]: ^77777713 x 13 cells around character.^000000",
		"[Lv 5]: ^777777Full screen around character.^000000"
	},
	[SKID.SU_SVG_SPIRIT] = {
		"[Spirit Of Savage]",
		"Max Level: 5",
		...
		"Class: ^777777Animal (ATK)^000000",
		"Description: ^777777Summon a Spirit of Savage to rush attack to the target.^000000",
		"^777777Straight fire to the designated point and damaging all enemies within the line.^000000",
		"[Lv 1]: ^777777Attack +400%.^000000",
		"[Lv 2]: ^777777Attack +550%.^000000",
		"[Lv 3]: ^777777Attack +700%.^000000",
		"[Lv 4]: ^777777Attack +850%.^000000",
		"[Lv 5]: ^777777Attack +1000%.^000000"
	},
	[SKID.SU_SPIRITOFSEA] = {
		"[Spirit Of Sea]",
		"Max Level: 1",
		...
		"Class: ^000099Passive^000000",
		"Description: ^777777Absorb a Spirit of Sea to strengthen [Seafood] class skills.^000000",
		"* [Fresh Shrimp] - ^777777Doubled HP recovery.^000000",
		"* [Bunch of Shrimp] - ^777777Duration: 120 seconds more. Also increasing ATK, MATK.^000000",
		"* [Tuna Belly] - ^777777Cooldown -5 seconds.^000000",
		"* [Tuna Party] - ^777777More absorbs damage.^000000",
	...
	[SKID.SU_SPIRITOFLAND] = {
		...
		"Class: ^000099Passive^000000",
		"Description: ^777777Absorb a Spirit of Land to strengthen [Vegetable] class skills.^000000",
		"* [SV Stem Spear] - ^777777Greatly increase movement speed for 3 seconds.^000000",
		"* [SV Root Twist] - ^777777Increase MATK as much as BaseLV for 3 seconds.^000000",
		"* [CN Powdering] - ^777777Increase perfect dodge as much as BaseLV/12 for 3 seconds.^000000",
	...
	[SKID.SU_SPIRITOFLIFE] = {
		...
		"Class: ^000099Passive^000000",
		"Description: ^777777Absorb a Spirit of Life to strengthen [Animal] class skills.^000000",
		"^777777Increase below skills damage due to remained HP:^000000",
		"* [Picky Peck];",
		"* [Scar of Tarou];",
		"* [Lunatic Carrot Beat];",
		"* [Spirit Of Savage]."
