...
queryNavi_Distance_Link = function(Index, Index2)
	if Navi_Distance[Index + 2] == nil then
		return nil
	elseif Navi_Distance[Index + 2][Index2] == nil then
		return nil
	end
...
queryNavi_Distance_Pass = function(Index, Index2, Index3)
	...
	elseif Navi_Distance[Index + 2][Index2] == nil then
		return nil, nil, nil
	elseif Navi_Distance[Index + 2][Index2][Index3] == nil then
		return nil, nil, nil
	end
...
queryNavi_NpcDistance_Link = function(Index, Index2)
	if Navi_NpcDistance[Index + 2] == nil then
		return nil
	elseif Navi_NpcDistance[Index + 2][Index2] == nil then
		return nil
	end
...
queryNavi_NpcDistance_Pass = function(Index, Index2, Index3)
	...
	elseif Navi_NpcDistance[Index + 2][Index2] == nil then
		return nil, nil, nil
	elseif Navi_NpcDistance[Index + 2][Index2][Index3] == nil then
		return nil, nil, nil
	end
...
queryNavi_Scroll_Pass = function(Index, Index2)
	if Navi_Scroll[Index] == nil then
		return nil, nil
	elseif Navi_Scroll[Index][Index2 + 6] == nil then
		return nil, nil
	end
...
-- Function #12
queryNavi_PickNpc = function(Index)
