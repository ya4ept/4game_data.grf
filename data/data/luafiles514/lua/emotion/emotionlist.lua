...
InsertEmotionMsgListTable(ET_DELIGHT, "/¤Ў")
...
InsertEmotionMsgListTable(ET_THANKS, "/¤Ј")
...
InsertEmotionMsgListTable(ET_SMILE, "/ЗПЗП")
...
InsertEmotionMsgListTable(ET_BEST, "/їшГт")
InsertEmotionMsgListTable(ET_BEST, "/¤є")
...
InsertEmotionMsgListTable(ET_HUK, "/¤ѕ")
...
InsertEmotionMsgListTable(ET_HELP, "/¤є¤є")
...
InsertEmotionMsgListTable(ET_KIK, "/Е±")
InsertEmotionMsgListTable(ET_KIK, "/¤»")
InsertEmotionMsgListTable(ET_KIK, "/ДЙДЙ")
...
InsertEmotionMsgListTable(ET_OK, "/Іфґц")
...
InsertEmotionMsgListTable(ET_SHY, "/єО")
...
InsertEmotionMsgListTable(ET_SPTIME, "/їҐ")
...
InsertEmotionMsgListTable(ET_SLEEPY, "/¤ё")
...
InsertEmotionMsgListTable(ET_CONGRATULATION, "/¤є¤»")
...
InsertEmotionMsgListTable(ET_HPTIME, "/ЗЗ")
...
InsertEmotionMsgListTable(ET_OHNO, "/ЗСјы")
...
InsertEmotionMsgListTable(ET_BLABLA, "/ЅГІшЅГІш")
...
InsertEmotionMsgListTable(ET_ROCK, "/№ЩА§")
...
InsertEmotionMsgListTable(ET_HUM2, "/Им")
...
InsertEmotionMsgListTable(ET_ABS, "/ёЫ")
...
InsertEmotionMsgListTable(ET_OOPS, "/їу")
...
InsertEmotionMsgListTable(ET_SPIT, "/АЎ")
...
InsertEmotionMsgListTable(ET_ENE, "/Е»·В")
...
InsertEmotionMsgListTable(ET_PANIC, "/°шИІ")
...
InsertEmotionMsgListTable(ET_WHISP, "/А§ЅєЖЫ")
...
InsertEmotionMsgListTable(ET_YUT1, "/А·")
