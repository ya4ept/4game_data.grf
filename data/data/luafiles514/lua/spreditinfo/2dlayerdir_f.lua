...
GetSpriteInheriteJob = function(jobID)
	...
	local sizeType = GetLayerSizeType(robeID)
	if sizeType == LAYER_BIG and EXCEPTION_SPRITE_INHERIT_LIST ~= nil then
...
DrawOnTop = function(robeID, sex, jobID, actNum, motNum)
	...
	if LayerDirTbl ~= nil and LayerDirTbl[jobID] ~= nil then
		...
		while motInfo ~= nil do
			...
			idx = idx + 1
			motInfo = LayerDirTbl[jobID][actNum][idx + 1]
		end
		return true
	else
		return true
