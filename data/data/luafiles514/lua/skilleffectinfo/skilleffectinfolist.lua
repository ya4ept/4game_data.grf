SKILL_EFFECT_INFO_LIST = {
	[SKID.NJ_KUNAI] = {
		waveFileName = "effect\\ґСАЪ_ґшБц±в.wav",
		effectNum = 1,
	...
	[SKID.KO_SETSUDAN] = {
		...
		targetWaveFileName = "effect\\T_Аь±в.wav",
		targetEffectNum = 1,
	...
	[SKID.KO_BAKURETSU] = {
		...
		targetWaveFileName = "effect\\Жшї°·ж.wav",
		targetEffectNum = 1,
	...
	[SKID.KO_HAPPOKUNAI] = {
		beginMotionType = ACTOR_STATE.ST_NINJASKILL2,
		waveFileName = "effect\\T_ИёїАё®Вч±в.wav",
		effectNum = 2,
	...
	[SKID.KG_KYOMU] = {
		targetWaveFileName = "effect\\t_їЎіКБц№жГв.wav",
		targetEffectNum = 1,
		targetEffectID = { EFID.EF_KG_KYOMU },
		onTarget = true
	},
	[SKID.KG_KAGEMUSYA] = {
		targetWaveFileName = "effect\\mon_±Э°­єТ±«.wav",
		targetEffectNum = 1,
	...
	[SKID.OB_ZANGETSU] = {
		...
		targetWaveFileName = "effect\\t_µыµнЗСё¶№э.wav",
		targetEffectNum = 1,
