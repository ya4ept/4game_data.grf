...
-- Function #0
ReadEmitterInfoz = function(tablename)
...
-- Function #1
ReadMagicFloorInfoz = function(tablename)
	local t = _G[tablename]
	if t ~= nil then
		for k, v in pairs(t) do
...
-- Function #2
ReadEvilsPawInfoz = function(tablename)
	local t = _G[tablename]
	if t ~= nil then
		for k, v in pairs(t) do
...
-- Function #3
ReadAnimatedEmitterInfoz = function(tablename)
	local t = _G[tablename]
	if t ~= nil then
		for k, v in pairs(t) do
...
-- Function #4
ReadEmitterInfoz_ver_1_0 = function(tablename)
	local t = _G[tablename]
...
-- Function #5
ReadEffectInfoz = function(tablename)
	local t = _G[tablename]
	if t ~= nil then
		for k, v in pairs(t) do
