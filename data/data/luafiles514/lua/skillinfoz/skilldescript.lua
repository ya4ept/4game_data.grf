SKILL_DESCRIPT = {
	...
	[SKID.HP_BASILICA] = {
		"[Basilica]",
		"Max Level: 5",
		"Skill Requirements: ^777777Kyrie Eleison 4,",
		"Increase SP Recovery 1, Gloria 2^000000",
		"Skill Form: ^777777Supportive^000000",
		"Description: ^777777Blocks all enemies and attacks",
		"from entering the skill's area of effect. The",
		"skill does not work against Boss monsters",
		"and WoE guardians. Basilica cannot be cast",
		"if there is an obstacle in the area. ^00BB00Each cast",
		"requires 1 Holy Water, 1 Yellow Gemstone,",
		"1 Blue Gemstone, and 1 Red Gemstone.^777777^000000",
		"[Lv. 1] ^777777Duration: 20 sec.^000000",
