EFST_IDs = {
	...
	EFST_MAX_HP_SP_AVOID = 1305,
	EFST_ADD_ALL_STATE = 1306,
	EFST_AID_PERIOD_POWER_ACCELERATION = 1307,
	EFST_AID_PERIOD_MAX_HP_SP_AVOID = 1308,
	EFST_AID_PERIOD_ADD_ALL_STATE = 1309,
	...
	EFST_SHOW_NPCHPBAR = 821,
	EFST_FLOWERSMOKE = 822,
	EFST_FSTONE = 823,
	EFST_DAILYSENDMAILCNT = 824,
	EFST_MINIGAME_ROULETTE = 845,
	EFST_MINIGAME_GOLD_POINT = 846,
	EFST_MINIGAME_SILVER_POINT = 847,
	EFST_MINIGAME_BRONZE_POINT = 848,
	EFST_HAPPINESS_STAR = 849,
	EFST_SUMMEREVENT01 = 850,
	EFST_SUMMEREVENT02 = 851,
	EFST_SUMMEREVENT03 = 852,
	EFST_SUMMEREVENT04 = 853,
	EFST_SUMMEREVENT05 = 854,
	EFST_MINIGAME_ROULETTE_BONUS_ITEM = 855,
	EFST_DRESS_UP = 856,
	EFST_MAPLE_FALLS = 857,
	EFST_ALL_NIFLHEIM_RECALL = 858,
	EFST_MARKING_USE_CHANGEMONSTER = 859,
	EFST_MAGICAL_FEATHER = 864,
	EFST_ALL_PRONTERA_RECALL = 866,
	EFST_GIFT_OF_SNOW = 868,
	EFST_NPC_HALLUCINATIONWALK = 869,
	EFST_NPC_HALLUCINATIONWALK_POSTDELAY = 870,
	EFST_NPC_XXXWALK = 871,
	EFST_HEAD_EQUIPMENT_EFFECT = 895,
	EFST_REUSE_LIMIT_MG = 934,
	EFST_ALL_GLASTHEIM_RECALL = 943,
	EFST_REUSE_LIMIT_PEPO_MD = 944,
	EFST_ALL_THANATOS_RECALL = 945,
	EFST_KAFRA_STORE = 946,
	EFST_REUSE_ABBYS = 947,
	EFST_PRIVATE_AIRPLANE = 949,
	EFST_HISS_AVOID = 951,
	EFST_CHATTERING_OPT_ATK_MATK = 954,
	EFST_CHATTERING_OPT_HASTE = 955,
	EFST_SPIRITOFLAND_STEMSPEAR = 956,
	EFST_SPIRITOFLAND_ROOTTWIST = 957,
	EFST_SPIRITOFLAND_POWDERING = 958,
	EFST_SPIRITOFLAND_METEOR = 959,
	EFST_SPIRITOFLAND_NYANGGRASS = 960,
	EFST_REUSE_LIMIT_MOVEPOINT = 977,
	EFST_MACRO_DETECTOR_ANSWER_WAITING = 978,
	EFST_SOULATTACK = 982,
	EFST_PRONTERA_JP = 986,
	EFST_ASSISTANT_VENDING = 987,
	EFST_ASSISTANT_BUYING = 991,
	EFST_GET_CNT_UNREAD_RODEX_CHARDB = 993,
	EFST_GET_CNT_UNREAD_RODEX_GLOBALDB = 994,
	EFST_OPEN_REFINING_UI = 997,
	EFST_ALL_LIGHTHALZEN_RECALL = 998,
	EFST_SWAP_EQUIPITEM = 999,
	EFST_TAEKWON_MISSION = 1005,
	EFST_SUN_PLACE = 1006,
	EFST_MOON_PLACE = 1007,
	EFST_STAR_PLACE = 1008,
	EFST_SUN_MONSTER = 1009,
	EFST_MOON_MONSTER = 1010,
	EFST_STAR_MONSTER = 1011,
	EFST_AL_WARP_ADDSLOT = 1012,
	EFST_DAMAGE_HEAL2 = 1028,
	EFST_DAMAGE_HEAL3 = 1029,
	XXX_EFST_WORLDSTORE_ACTIVE = 1051,
	EFST_WORLDSTORE_ITEMMOVEINFO_SENDCOMPLETE = 1052,
	EFST_KAUTE = 1074,
	EFST_REUSE_LIMIT_THM = 1075,
	EFST_REUSE_LIMIT_TLI = 1076,
	EFST_REUSE_LIMIT_TKC = 1077,
	EFST_REUSE_LIMIT_TRP = 1078,
	EFST_REUSE_LIMIT_TBG = 1079,
	EFST_REUSE_LIMIT_TBM = 1080,
	EFST_USE_SKILL_SP_SWHOO = 1082,
	EFST_EXPDROPUP = 1086,
	EFST_DANCINGLESSON = 1090,
	EFST_MUSICALLESSON = 1091,
	EFST_REUSE_LIMIT_RC = 1092,
	EFST_DANCINGLESSON_EQUIPPED = 1093,
	EFST_MUSICALLESSON_EQUIPPED = 1094,
	EFST_REUSE_LIMIT_POTION_A = 1096,
	EFST_REUSE_LIMIT_POTION_B = 1097,
	EFST_REUSE_LIMIT_POTION_C = 1098,
	EFST_REUSE_LIMIT_POTION_D = 1099,
	EFST_REUSE_LIMIT_POTION_E = 1100,
	EFST_REUSE_LIMIT_POTION_F = 1101,
	EFST_BRAVESET = 1102,
	EFST_MACEMASTERY_EQUIPPED = 1103,
	EFST_TEST_KR01 = 1105,
	EFST_STARFISH_JP = 1106,
	EFST_CRI_DAMAGE = 1108,
	EFST_DEF_POWER = 1109,
	EFST_DEF_IGNORE = 1110,
	EFST_BOW_ATK_POWER = 1111,
	EFST_RED_ORG_POTION = 1112,
	EFST_CAST_TIME = 1113,
	EFST_BLADESTOPREADY = 1114,
	EFST_TELEPORT_BR = 1115,
	EFST_SA_WEAPON_PROPERTY = 1116,
	EFST_LEAPIMPAIRED = 1117,
	EFST_SENDING_ITEMLIST = 1118,
	EFST_STOPMOVE_IMMEDIATELY = 1124,
	EFST_DF_MANAPLUS = 1127,
	EFST_DF_FULLSWINGK = 1128,
	EFST_REUSE_SKILL = 1134,
	EFST_CHARM_BOOST = 1138,
	EFST_EARTHSHAKER = 1139,
	EFST_PERIOD_USE_WORLDMAP = 1140,
	EFST_MOVE_AGIT = 1143,
	EFST_REUSE_JPNONLY_LIMIT_I = 1144,
	EFST_REUSE_JPNONLY_LIMIT_J = 1145,
	EFST_REUSE_JPNONLY_LIMIT_K = 1146,
	EFST_PRISON = 1148,
	EFST_MADOGEAR_TYPE = 1149,
	EFST_FEINTBOMB = 1153,
	EFST_GRADE_ENCHANT_UI_OPEN = 1168,
	EFST_WILL_OF_FAITH = 1179,
	EFST_PRESSURE = 1180,
	EFST_SA_DRAGONOLOGY = 1181,
	EFST_MD_Me_Potion = 1185,
	EFST_MD_Ma_Potion = 1186,
	EFST_MD_Ta_Potion = 1187,
	EFST_MD_Ra_Potion = 1188,
	EFST_REUSE_MEGAPHONE = 1189,
	EFST_FIDUS_ANIMUS = 1224,
	EFST_MACE_BOOK_M = 1225,
	EFST_MVPCARD_KIEL = 1229,
	EFST_TWOHANDDEF = 1246,
	EFST_CRESCIVEBOLT3 = 1253,
	EFST_BO_BIONIC_PHARMACY_OPERATOR = 1265,
	EFST_RENOVATIO_EXT = 1302,
	EFST_HACKANDSLASHER = 1311,
	EFST_GET_CNT_UNREAD_RETURN_RODEX_CHARDB = 1312,
	EFST_REUSE_LIMIT_I = 1314,
	EFST_AUTOSHADOWSPELL_CHECK2 = 1317,
	EFST_DEFSCROLL = 1321,
