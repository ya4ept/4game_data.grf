...
StateIconList[EFST_IDs.EFST_SIROMA_ICE_TEA] = {
	...
	posTimeLimitStr = 2,
	descript = {
		{ "Siroma Ice Tea", COLOR_TITLE_BUFF },
		{ "%s", COLOR_TIME },
		{ "Increase DEX" }
	}
}
...
StateIconList[EFST_IDs.EFST_PUTTI_TAILS_NOODLES] = {
	...
	posTimeLimitStr = 2,
	descript = {
		{ "Petite Tail Noodles", COLOR_TITLE_BUFF },
		{ "%s", COLOR_TIME },
		{ "Increase LUK" }
	}
}
...
StateIconList[EFST_IDs.EFST_GRANITIC_ARMOR] = {
	...
	descript = {
		...
		{ "%s", COLOR_TIME },
		{ "Reduces damage taken by Dieter and its owner" },
		{ "Consumes HP once the effect ends" }
	}
}
...
StateIconList[EFST_IDs.EFST_LIGHT_OF_REGENE] = {
	...
	posTimeLimitStr = 2,
	descript = {
		{ "Light of Regenerate", COLOR_TITLE_BUFF },
		{ "%s", COLOR_TIME },
		{ "When the owner dies," },
		{ "Eira sacrifices herself to revive her owner" }
	}
}
...
StateIconList[EFST_IDs.EFST_MEIKYOUSISUI] = {
	...
	descript = {
		...
		{ "When receiving damage, effect ends" }
	}
}
...
StateIconList[EFST_IDs.EFST_OVERED_BOOST] = {
	...
	posTimeLimitStr = 2,
	descript = {
		{ "Overe Boost", COLOR_TITLE_BUFF },
		{ "%s", COLOR_TIME },
		{ "Eira and owner's" },
		{ "attack speed and evasion increased" }
	}
}
...
StateIconList[EFST_IDs.EFST_VOLCANIC_ASH] = {
	...
	descript = {
		...
		{ "%s", COLOR_TIME },
		{ "Accuracy Drops" },
		{ "Chance to fail using skills" },
		{ "Receive more Fire Property damage" }
	}
}
...
StateIconList[EFST_IDs.EFST_AID_PERIOD_ADDSTOREITEMCOUNT] = {
	...
	posTimeLimitStr = 2,
	descript = {
		{ "Storage expanded", COLOR_TITLE_BUFF },
		{ "%s", COLOR_TIME },
		{ "Storage slots +300" }
	}
}
...
StateIconList[EFST_IDs.EFST_EL_WAIT] = {
	...
	posTimeLimitStr = 2,
	descript = {
		{ "Elemental Spirit Waiting Mode", COLOR_TITLE_BUFF },
		{ "%s", COLOR_TIME },
		{ "" }
	}
}
StateIconList[EFST_IDs.EFST_EL_PASSIVE] = {
	...
	posTimeLimitStr = 2,
	descript = {
		{ "Elemental Spirit Passive Mode", COLOR_TITLE_BUFF },
		{ "%s", COLOR_TIME },
		{ "" }
	}
}
StateIconList[EFST_IDs.EFST_EL_DEFENSIVE] = {
	...
	posTimeLimitStr = 2,
	descript = {
		{ "Elemental Spirit Defensive Mode", COLOR_TITLE_BUFF },
		{ "%s", COLOR_TIME },
		{ "" }
	}
}
StateIconList[EFST_IDs.EFST_EL_OFFENSIVE] = {
	...
	posTimeLimitStr = 2,
	descript = {
		{ "Elemental Spirit Offensive Mode", COLOR_TITLE_BUFF },
		{ "%s", COLOR_TIME },
		{ "" }
	}
}
...
StateIconList[EFST_IDs.EFST_PROTECTIONOFSHRIMP] = {
	...
	posTimeLimitStr = 2,
	descript = {
		{ "Blessing of Shrimp", COLOR_TITLE_BUFF },
		{ "%s", COLOR_TIME }
	}
}
