...
StateIconList[EFST_IDs.EFST_EXPIATIO] = {
	...
	descript = {
		...
		{ "%s", COLOR_TIME },
		{ "Шанс проигнорировать физическую и магическую защиту противника при атаке." }
	}
}
...
StateIconList[EFST_IDs.EFST_LAUDARAMUS] = {
	...
	posTimeLimitStr = 2,
	descript = {
		{ "Лауда Рамус", COLOR_TITLE_BUFF },
		{ "%s", COLOR_TIME },
		{ "Увеличен критический урон" }
	}
}
StateIconList[EFST_IDs.EFST_SUNSTANCE] = {
	...
	posTimeLimitStr = 2,
	descript = {
		{ "Стойка солнца", COLOR_TITLE_BUFF },
		{ "%s", COLOR_TIME },
		{ "Увеличен урон" },
		{ "Солнечные умения доступны для применения" }
	}
}
StateIconList[EFST_IDs.EFST_LUNARSTANCE] = {
	...
	posTimeLimitStr = 2,
	descript = {
		{ "Стойка луны", COLOR_TITLE_BUFF },
		{ "%s", COLOR_TIME },
		{ "Макс. HP увеличено" },
		{ "Лунные умения доступны для применения" }
	}
}
StateIconList[EFST_IDs.EFST_STARSTANCE] = {
	...
	posTimeLimitStr = 2,
	descript = {
		{ "Стойка звезд", COLOR_TITLE_BUFF },
		{ "%s", COLOR_TIME },
		{ "Скорость атаки увеличена" },
		{ "Звездные умения доступны для применения" }
	}
}
StateIconList[EFST_IDs.EFST_UNIVERSESTANCE] = {
	...
	posTimeLimitStr = 2,
	descript = {
		{ "Космическая стойка", COLOR_TITLE_BUFF },
		{ "%s", COLOR_TIME },
		{ "Все характеристики увеличены" },
		{ "Космические умения доступны для применения" },
		{ "Звездные умения доступны для применения" },
		{ "Лунные умения доступны для применения" },
		{ "Солнечные умения доступны для применения" }
	}
...
StateIconList[EFST_IDs.EFST_LIGHTOFSUN] = {
	...
	posTimeLimitStr = 2,
	descript = {
		{ "Солнечный свет", COLOR_TITLE_BUFF },
		{ "%s", COLOR_TIME },
		{ "Урон от умения [Солнечный взрыв] увеличен" }
	}
}
StateIconList[EFST_IDs.EFST_LIGHTOFMOON] = {
	...
	posTimeLimitStr = 2,
	descript = {
		{ "Лунный свет", COLOR_TITLE_BUFF },
		{ "%s", COLOR_TIME },
		{ "Урон от умения [Удар полной луны] увеличен" }
	}
}
StateIconList[EFST_IDs.EFST_LIGHTOFSTAR] = {
	...
	posTimeLimitStr = 2,
	descript = {
		{ "Звездный свет", COLOR_TITLE_BUFF },
		{ "%s", COLOR_TIME },
		{ "Урон от умения [Падающей звезды] увеличен" }
	}
}
StateIconList[EFST_IDs.EFST_FLASHKICK] = {
	descript = {
		{ "Звездная метка", COLOR_TITLE_DEBUFF }
	}
}
StateIconList[EFST_IDs.EFST_NEWMOON] = {
	...
	posTimeLimitStr = 2,
	descript = {
		{ "Новолуние", COLOR_TITLE_BUFF },
		{ "%s", COLOR_TIME },
		{ "Персонаж может передвигаться, не раскрывая своего местоположения" },
		{ "Доступно для применения умение [Удар молодой луны]" }
	}
}
StateIconList[EFST_IDs.EFST_CREATINGSTAR] = {
	descript = {
		{ "Первозданная сила", COLOR_TITLE_DEBUFF },
		{ "Снижена скорость передвижения" }
	}
}
StateIconList[EFST_IDs.EFST_GRAVITYCONTROL] = {
	descript = {
		{ "Контроль гравитации", COLOR_TITLE_DEBUFF },
		{ "Перемещение или атака невозможны" }
	}
}
StateIconList[EFST_IDs.EFST_SOULCOLLECT] = {
	...
	posTimeLimitStr = 2,
	descript = {
		{ "Коллекционирование душ", COLOR_TITLE_BUFF },
		{ "%s", COLOR_TIME },
		{ "Периодически собирает энергию души" }
	}
}
StateIconList[EFST_IDs.EFST_SOULREAPER] = {
	...
	posTimeLimitStr = 2,
	descript = {
		{ "Урожай душ", COLOR_TITLE_BUFF },
		{ "%s", COLOR_TIME },
		{ "Шанс получить " },
		{ "энергию души при атаке" }
	}
}
StateIconList[EFST_IDs.EFST_SOULUNITY] = {
	...
	posTimeLimitStr = 2,
	descript = {
		{ "Единение душ", COLOR_TITLE_BUFF },
		{ "%s", COLOR_TIME },
		{ "Восстанавливает HP раз в 3 секунды" },
		{ "Персонаж может быть целью умения [Каут]" }
	}
}
...
StateIconList[EFST_IDs.EFST_SOULGOLEM] = {
	...
	posTimeLimitStr = 2,
	descript = {
		{ "Душа голема", COLOR_TITLE_BUFF },
		{ "%s", COLOR_TIME },
		{ "Защита увеличена" },
		{ "Маг. защита увеличена" }
	}
}
StateIconList[EFST_IDs.EFST_SOULDIVISION] = {
	descript = {
		{ "Отделение души", COLOR_TITLE_DEBUFF },
		{ "Задержка применения умений увеличена" }
	}
}
StateIconList[EFST_IDs.EFST_FALLINGSTAR] = {
	...
	posTimeLimitStr = 2,
	descript = {
		{ "Падающая звезда", COLOR_TITLE_BUFF },
		{ "%s", COLOR_TIME },
...
StateIconList[EFST_IDs.EFST_SOULCURSE] = {
	...
	posTimeLimitStr = 2,
	descript = {
		{ "Проклятие", COLOR_TITLE_BUFF },
		{ "%s", COLOR_TIME },
		{ "Снижено сопротивление атакам элемента [Тьма]" }
	}
}
