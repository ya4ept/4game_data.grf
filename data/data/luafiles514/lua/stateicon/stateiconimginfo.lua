...
StateIconImgList = {
	...
	PRIORITY_RED = {
		...
		[EFST_IDs.EFST_HANDICAPSTATE_ICEEXPLO] = "ґЩАМѕЖёуµеґхЅєЖ®.TGA",
		[EFST_IDs.EFST_DARKCROW] = "DARKCROW.TGA",
		[EFST_IDs.EFST_REBOUND] = "REBOUND.TGA",
		[EFST_IDs.EFST_CHILL] = "i_starcomfort.tga",
		[EFST_IDs.EFST_BURNT] = "їА№цИчЖ®.tga",
		[EFST_IDs.EFST_GLASTHEIM_TRANS] = "GLASTHEIM_TRANS.tga",
		[EFST_IDs.EFST_B_TRAP] = "№ЩАОµеЖ®·¦.tga",
		[EFST_IDs.EFST_P_ALTER] = "ЗГ·ЎЖјіСѕЛЕН.tga",
		[EFST_IDs.EFST_C_MARKER] = "Е©ёІБрё¶Дї.tga",
		...
		[EFST_IDs.EFST_LOCKON_LASER] = "Е©ёІБрё¶Дї.tga",
		...
		[EFST_IDs.EFST_CLOUD_POISON] = "Е¬¶уїмµеЕі.tga",
		[EFST_IDs.EFST_SPORE_EXPLOSION_DEBUFF] = "ѕИЖјёЕЕНё®ѕу.tga",
	...
	PRIORITY_BLUE = {
		...
		[EFST_IDs.EFST_M_LIFEPOTION] = "јТЗь»эёнјц.TGA",
		...
		[EFST_IDs.EFST_GLASTHEIM_HIDDEN] = "ё¶№э№жѕоЖчјЗ.TGA",
		[EFST_IDs.EFST_GLASTHEIM_STATE] = "ELDICASTES.TGA",
		[EFST_IDs.EFST_GLASTHEIM_ITEMDEF] = "№°ё®№жѕоЖчјЗ.TGA",
		[EFST_IDs.EFST_GLASTHEIM_HPSP] = "gogi.TGA",
		[EFST_IDs.EFST_ALMIGHTY] = "ЅЕАЗ¶ж.TGA",
		...
		[EFST_IDs.EFST_2013_VALENTINE1] = "±Ы·Оё®ѕЖ.tga",
		[EFST_IDs.EFST_2013_VALENTINE2] = "gogi.TGA",
		[EFST_IDs.EFST_2013_VALENTINE3] = "Иёє№·ВЗв»уЖчјЗ.tga",
		[EFST_IDs.EFST_JITTER_BUFF1] = "Иёє№·ВЗв»уЖчјЗ.tga",
		[EFST_IDs.EFST_JITTER_BUFF2] = "Иёє№·ВЗв»уЖчјЗ.tga",
		[EFST_IDs.EFST_JITTER_BUFF3] = "Иёє№·ВЗв»уЖчјЗ.tga",
		[EFST_IDs.EFST_JITTER_BUFF4] = "Иёє№·ВЗв»уЖчјЗ.tga",
		[EFST_IDs.EFST_JITTER_BUFF5] = "Иёє№·ВЗв»уЖчјЗ.tga",
		[EFST_IDs.EFST_JITTER_BUFF6] = "Иёє№·ВЗв»уЖчјЗ.tga",
		[EFST_IDs.EFST_JITTER_BUFF7] = "Иёє№·ВЗв»уЖчјЗ.tga",
		[EFST_IDs.EFST_JITTER_BUFF8] = "Иёє№·ВЗв»уЖчјЗ.tga",
		[EFST_IDs.EFST_JITTER_BUFF9] = "Иёє№·ВЗв»уЖчјЗ.tga",
		[EFST_IDs.EFST_JITTER_BUFF10] = "Иёє№·ВЗв»уЖчјЗ.tga",
		[EFST_IDs.EFST_CUP_OF_BOZA] = "gogi.TGA",
		[EFST_IDs.EFST_PACKING_ENVELOPE1] = "Иёє№·ВЗв»уЖчјЗ.tga",
		[EFST_IDs.EFST_PACKING_ENVELOPE2] = "Иёє№·ВЗв»уЖчјЗ.tga",
		[EFST_IDs.EFST_PACKING_ENVELOPE3] = "Иёє№·ВЗв»уЖчјЗ.tga",
		[EFST_IDs.EFST_PACKING_ENVELOPE4] = "Иёє№·ВЗв»уЖчјЗ.tga",
		[EFST_IDs.EFST_PACKING_ENVELOPE5] = "Иёє№·ВЗв»уЖчјЗ.tga",
		[EFST_IDs.EFST_PACKING_ENVELOPE6] = "Иёє№·ВЗв»уЖчјЗ.tga",
		[EFST_IDs.EFST_PACKING_ENVELOPE7] = "Иёє№·ВЗв»уЖчјЗ.tga",
		[EFST_IDs.EFST_PACKING_ENVELOPE8] = "Иёє№·ВЗв»уЖчјЗ.tga",
		[EFST_IDs.EFST_PACKING_ENVELOPE9] = "Иёє№·ВЗв»уЖчјЗ.tga",
		[EFST_IDs.EFST_PACKING_ENVELOPE10] = "Иёє№·ВЗв»уЖчјЗ.tga",
		[EFST_IDs.EFST_ZONGZI_POUCH_TRANS] = "UNLIMIT.TGA",
		[EFST_IDs.EFST_OVERSEAEXPUP] = "exp.tga",
		[EFST_IDs.EFST_OVERLAPEXPUP] = "EXP_ё»¶ыµµ_°нѕзАМДµ.tga",
		[EFST_IDs.EFST_BEEF_RIB_STEW] = "ґлИЇґЬ.tga",
		[EFST_IDs.EFST_PORK_RIB_STEW] = "ЕВГ»ґЬ.tga",
		...
		[EFST_IDs.EFST_S_HEALPOTION] = "јТЗь»эёнјц.TGA",
		...
		[EFST_IDs.EFST_LIMIT_POWER_BOOSTER] = "Жш±в.tga",
		...
		[EFST_IDs.EFST_CHERRY_BLOSSOM_CAKE] = "№°ё®№жѕоЖчјЗ.TGA",
		...
		[EFST_IDs.EFST_HELM_VERKANA] = "№°ё®№жѕоЖчјЗ.TGA",
		[EFST_IDs.EFST_HELM_RHYDO] = "№°ё®№жѕоЖчјЗ.TGA",
		[EFST_IDs.EFST_HELM_TURISUS] = "№°ё®№жѕоЖчјЗ.TGA",
		[EFST_IDs.EFST_HELM_HAGALAS] = "№°ё®№жѕоЖчјЗ.TGA",
		[EFST_IDs.EFST_HELM_ISIA] = "№°ё®№жѕоЖчјЗ.TGA",
		[EFST_IDs.EFST_HELM_ASIR] = "№°ё®№жѕоЖчјЗ.TGA",
		[EFST_IDs.EFST_HELM_URJ] = "№°ё®№жѕоЖчјЗ.TGA",
		[EFST_IDs.EFST_PERIOD_RECEIVEITEM] = "item.tga",
		[EFST_IDs.EFST_PERIOD_PLUSJOBEXP] = "job.tga",
		[EFST_IDs.EFST_PERIOD_PLUSEXP] = "exp.tga",
		[EFST_IDs.EFST_DORAM_BUF_01] = "јТЗь»эёнјц.TGA",
		[EFST_IDs.EFST_DORAM_BUF_02] = "јТЗь»эёнјц.TGA",
		...
		[EFST_IDs.EFST_PHARAOH_CARD] = "ґлИЇґЬ.tga",
		[EFST_IDs.EFST_KIEL_CARD] = "ЕВГ»ґЬ.tga",
		...
		[EFST_IDs.EFST_SPECIALCOOKIE] = "ЅЕАЗ¶ж.TGA",
		...
		[EFST_IDs.EFST_ASPD_POPCORN] = "°шјУ№°ѕа.TGA",
		[EFST_IDs.EFST_ULTIMATECOOK] = "ЅЕАЗ¶ж.TGA",
		...
		[EFST_IDs.EFST_OVERLAPEXPUP2] = "EXP_ё»¶ыµµ_°нѕзАМДµ.tga",
		...
		[EFST_IDs.EFST_AID_PERIOD_POWER_ACCELERATION] = "efst_atk.tga",
		[EFST_IDs.EFST_AID_PERIOD_MAX_HP_SP_AVOID] = "FLOWER_LEAF.tga",
		[EFST_IDs.EFST_AID_PERIOD_ADD_ALL_STATE] = "MYSTICPOWDER.tga",
		[EFST_IDs.EFST_BUCHEDENOEL] = "icon05.tga"
	},
	PRIORITY_GREEN = {
	...
	PRIORITY_WHITE = {
		...
		[EFST_IDs.EFST_E_CHAIN] = "АМЕНіОГјАО.tga",
		[EFST_IDs.EFST_HEAT_BARREL] = "ИчЖ®№и·І.tga",
		[EFST_IDs.EFST_ANTI_M_BLAST] = "ѕИЖјёЕЕНё®ѕу.tga",
		...
		[EFST_IDs.EFST_S_MANAPOTION] = "ґлИЇґЬ.TGA",
		[EFST_IDs.EFST_M_DEFSCROLL] = "ЗГ·ЎЖјіСѕЛЕН.TGA",
		[EFST_IDs.EFST_DEFSCROLL] = "ЗГ·ЎЖјіСѕЛЕН.TGA",
		...
		[EFST_IDs.EFST_WEAPONBLOCK_ON] = "їюЖщєн·ОЕ·.tga",
		...
		[EFST_IDs.EFST_MOONLIT_SERENADE] = "ґЮєыАЗјј·№іЄµҐ.tga",
		...
		[EFST_IDs.EFST_E_SLASH_COUNT] = "rk_turisuss.tga",
		...
		[EFST_IDs.EFST_PYROCLASTIC] = "µрАМЕН4.tga",
		[EFST_IDs.EFST_RAISINGDRAGON] = "Аб·жЅВГµ.tga",
		[EFST_IDs.EFST_MAGICPOWER] = "ё¶№э·ВБхЖш.TGA",
		...
		[EFST_IDs.EFST_PAIN_KILLER] = "јј¶у4.tga",
